...
export default function MobileDevelopmentPage() {
    ...
    const stepsData: IStepBlock[] = useMemo(
        () => [
            {
                step: 1,
                text: t('mobile-development-steps-description-1'),
                caption: t('mobile-development-steps-caption-1'),
            },
            {
                step: 2,
                text: t('mobile-development-steps-description-2'),
                caption: t('mobile-development-steps-caption-2'),
            },
            {
                step: 3,
                text: t('mobile-development-steps-description-3'),
                caption: t('mobile-development-steps-caption-3'),
            },
            {
                step: 4,
                text: t('mobile-development-steps-description-4'),
                caption: t('mobile-development-steps-caption-4'),
            },
        ],
        [t]
    );
    ...
    const tarrifData: ITarrif[] = useMemo(
        () => [
            {
                title: t('mobile-development-tarrif-1-title'),
                text: [t('mobile-development-tarrif-1-text-1'), t('mobile-development-tarrif-1-text-2')],
            },
            {
                title: t('mobile-development-tarrif-2-title'),
                text: [t('mobile-development-tarrif-2-text-1'), t('mobile-development-tarrif-2-text-2')],
            },
            {
                title: t('mobile-development-tarrif-3-title'),
                text: [t('mobile-development-tarrif-3-text-1'), t('mobile-development-tarrif-3-text-2')],
            },
            {
                title: t('mobile-development-tarrif-4-title'),
                text: [t('mobile-development-tarrif-4-text-1'), t('mobile-development-tarrif-4-text-2')],
            },
        ],
        [t]
    );
